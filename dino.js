...
//load of sound and image
function preload() {
  soundFormats('mp3');
  mySound = loadSound('assets/audio/Small Dinosaur');
  mask = loadImage('assets/dino_mask.png');
}
...
//this function creates a circle everytime you shake the device
function deviceShaken() {
 mySound.play();
 circle(random(0, width), random(0, height), random(5, 30));
}
